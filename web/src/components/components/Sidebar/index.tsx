    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          <path fill-rule="evenodd" d="M9 0C5.96243 0 3.5 2.46243 3.5 5.5C3.5 8.53757 5.96243 11 9 11C12.0376 11 14.5 8.53757 14.5 5.5C14.5 2.46243 12.0376 0 9 0ZM5.5 5.5C5.5 3.567 7.067 2 9 2C10.933 2 12.5 3.567 12.5 5.5C12.5 7.433 10.933 9 9 9C7.067 9 5.5 7.433 5.5 5.5Z" fill="white"/>
        ...
        route: "#",
        children: [
          { label: "Create Org Admin", route: "/users/create-organization" },
          { label: "Create Agent", route: "/users/create-agent" },
          { label: "Create Org Member", route: "/users/create-org-member" },
          { label: "Agents", route:'/users/agents'},
          { label: "Organizations", route: '/users/organizations'}
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Create Form", route: "/forms/create-form" },
          { label: "Form List", route: "/forms/form-list" },
        ],
      },
