...
const user = {
  ...
  firstName: "John",
  lastName: "Doe",
  userType: "Agent", // Change this to "OrgAdmin" to test the other type
  agent: {
    id: 3,
    gender: "Female",
    age: 28,
  ...
  imageSrc: "", // Use an empty string or null to indicate no image
};

const Settings = () => {
  const isOrgAdmin = user.userType === "OrgAdmin";
                    ...
                    <>
                      <div className="mb-5.5">
                        ...
                        <input
                          ...
                          defaultValue={user.organization.organizationName}
                        />
                      </div>
                      ...
                      <div className="mb-5.5">
                        ...
                        <textarea
                          ...
                          defaultValue={user.organization.organizationDescription}
                        ></textarea>
                      </div>
                    </>
                  )}
