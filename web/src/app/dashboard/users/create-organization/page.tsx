...
const organizationValidationSchema = yup.object().shape({
  ...
  userType: yup.string().oneOf(['OrgAdmin'], 'User type must be OrgAdmin'),
...
const CreateOrganizationForm = () => {
  ...
  const onSubmit = async (data: any) => {
    const success = await createOrganization({ ...data, userType: 'OrgAdmin' });
              ...
              <div className="p-6.5">
                ...
                <div className="mb-4.5">
                  ...
                  <input
                    type="text"
                    {...register('firstName')}
                    placeholder="Enter Organization Admin first name"
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  />
                  {errors.firstName && (
                ...
                <div className="mb-4.5">
                  ...
                  <input
                    type="text"
                    {...register('lastName')}
                    placeholder="Enter Organization Admin last name"
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  />
                  {errors.lastName && (
