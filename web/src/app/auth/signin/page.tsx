...
const SignIn: React.FC = () => {
  ...
  const onSubmit =async (data: any) => {
    ...
    try {
 const respone =  await signIn({ email: data.email, password: data.password });
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <Link className="mb-5.5 inline-block" href="/">
                <Image className="hidden dark:block" src={logo} alt="Logo" width={176} height={32} />
                <Image className="dark:hidden" src={logo} alt="Logo" width={176} height={32} />
              </Link>
              <p className="2xl:px-20">
                This is Signin Page Platform X
              </p>
