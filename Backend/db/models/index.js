...
// // Recursive function to read models from subfolders
// function loadModelsFromDirectory(directory) {
//   fs.readdirSync(directory).forEach(file => {
//     const fullPath = path.join(directory, file);

//     // If it's a directory, recursively load models inside it
...
// // Call the function to load models from the main models directory
